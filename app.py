...
def get_drug_interactions(medications):
    ...
    prompt = f"Identify potential interactions and side effects between the following medications or tablet brands: {medications}. Provide advice for safe usage based on both the active ingredients and brand formulations."
    print("")
